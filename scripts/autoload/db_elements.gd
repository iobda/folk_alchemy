...
var _folklores: Dictionary = {
	"bastet": {
		...
		"description": "Древнеегипетская богиня кошек, домашнего уюта и плодородия. В древнем Египте кошки считались священными, а их убийство считалось тяжким преступлением.",
	...
	"succubus": {
		...
		"description": "Демон женского облика в легендах, который соблазнял мужчин во сне, высасывая их душу. Считалось, что от него защищают молитвы и святая вода.",
	...
	"banshi": {
		...
		"description": "Из ирландских легенд дух — предвестник смерти. Говорят, что её громкий и жуткий крик мог вызвать сильные ветры и даже торнадо, предвещая беду.",
		"tip" : "Подсказка: с помощью [color=green]ЭТОГО[/color] и [color=green]ЭТОГО[/color] у нас получается произносить звуки.",
		"source_1": "voice",
		"source_2": "tornado",
		"state": "closed"
	},
	"gorgon": {
		...
		"tip" : "Подсказка: её одолел Персей, великий герой Греции, с помощью зеркала и смекалки.",
		"source_1": "snake",
		"source_2": "eyes",
		"state": "closed"
	},
	...
	"vampire_cat": {
		...
		"tip" : "Подсказка: [color=green]ЭТО[/color] самое милое животные совмещённое с [color=green]ТЕМ[/color], кто спит днём.",
		"source_1": "cat",
		"source_2": "bat",
		"state": "closed"
	},
	...
	"redcap": {
		...
		"tip" : "Подсказка: в войнах проливается много [color=green]ЭТОГО[/color] и [color=green]ЭТОГО[/color].",
		"source_1": "hatred",
		"source_2": "blood",
		"state": "closed"
	},
